        ...
        child: new ListView(
          children:<Widget>[
            ...
            new ListTile(
                ...
                onTap: (){
                  Navigator.pop(ctxt);
                  Navigator.push(ctxt, new MaterialPageRoute(builder: (ctxt) => new MyHomePage(ctxt)));
                },
            ...
            new ListTile(
              ...
              onTap: (){
                Navigator.pop(ctxt);
                Navigator.push(ctxt, new MaterialPageRoute(builder: (ctxt) => new PuksiirautoTomPage()));
              },
            ),
            new ListTile(
              leading: CircleAvatar(
